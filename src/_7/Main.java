...
public class Main {
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "maicol";
        String middleName = "marco";
        String lastName = "cassarà";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "1.5"; // <--- Edit this line
        int doubleValue = 15;
        boolean booleanValue = true;
        System.out.println(textFrom2Primitives + doubleValue + booleanValue);
    }
